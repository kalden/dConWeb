	...
	print '
	  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
		<tr align="left">
		  ...
		  PrintSideMenuBox("Results",ResultSideMenuItems("Results","Documentation",$structId,$_GET["chain"],$selMeths["CATH"],$selMeths["SCOP"],$selMeths["DDomain"],$selMeths["Dodis"],$selMeths["PUU"],$selMeths["DHcL"],$selMeths["dp"],$selMeths["pdp"],$selMeths["NCBI"]));
		  print '
		  </td>
		  <td valign="top" align="left">
        <div id="textheading">Documentation</div><BR>

	<div id="textinfo">
	<div style="padding-left:20px; padding-top: 8px; padding-bottom: 8px;">
	Full documentation on how this tool was developed, as well as all programs that have been completed in the creation of this tool, can be accessed from <A HREF=http://sites.google.com/site/pdomainsguide/ target=”_blank”>http://sites.google.com/site/pdomainsguide/</A>
