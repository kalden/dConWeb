<?php
	...
	$redirect = 'consensus.php?pdbId='.$structId.'&CATH='.$selMeths["CATH"].'&SCOP='.$selMeths["SCOP"].'&pdp='.$selMeths["pdp"].'&chain='.$chainId.'&dp='.$selMeths["dp"].'&DHcL='.$selMeths["DHcL"].'&DDomain='.$selMeths["DDomain"].'&PUU='.$selMeths["PUU"].'&NCBI='.$selMeths["NCBI"].'&Dodis='.$selMeths["Dodis"];
	  ...
	  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
		<tr>
		  ...
		  <td>
			<TABLE WIDTH="75%">
			<TR>
			<TD align=center><p><BR><BR>Generating a Consensus from the selected methods, please wait</p></TD></TR>
		        <TR>
